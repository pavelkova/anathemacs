...
(defface sans-md  '((t :family "Lato" :height 130)) "md sans serif font")
(defface sans-lg  '((t :family "Lato" :height 150)) "lg sans serif font")
(defface sans-xl  '((t :family "Lato" :height 160)) "xl sans serif font")
