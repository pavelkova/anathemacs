...
(defface mono-xs '((t :family "CascadiaCode" :height 90)) "xs monospace font")
(defface mono-sm '((t :family "CascadiaCode" :height 100)) "sm monospace font")
(defface mono-md '((t :family "CascadiaCode" :height 110)) "md monospace font")
(defface mono-lg '((t :family "CascadiaCode" :height 120)) "lg monospace font")
(defface mono-xl '((t :family "CascadiaCode" :height 140)) "xl monospace font")
