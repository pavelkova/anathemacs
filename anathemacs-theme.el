...
;;;;; org
     `(org-archived ((,class (:foreground ,base-dim))))
     ...
     `(org-block-begin-line ((,class (:background ,cblk-bg :foreground ,cblk-ln :height 70))))
     `(org-block-end-line ((,class (:background ,cblk-bg :foreground ,cblk-ln :height 70))))
     ...
     `(org-date ((,class (:underline t :family ,base-font :foreground ,base-dim :height 95))))
     `(org-date-selected ((,class (:background ,highlight-dim :foreground ,bg1))))
     `(org-document-info ((,class (:slant italic))))
     `(org-document-info-keyword ((,class (:foreground ,meta :height 70))))
     `(org-document-title ((,class (:underline nil :height 320))))
     `(org-done ((,class (:foreground ,highlight-dim :background nil :strike-through nil :family ,base-font ))))
     `(org-drawer ((,class (:foreground ,comment :height 60))))
     `(org-ellipsis ((,class (:foreground ,comment :underline nil :height 60))))
     ...
     `(org-link ((,class (:underline t :foreground ,meta))))
     `(org-meta-line ((,class (:foreground ,comp :height 70))))
     `(org-mode-line-clock-overrun ((,class (:foreground ,err :height 70))))
     ...
     `(org-special-keyword ((,class (:foreground ,comment :height 60))))
     `(org-tag ((,class (:foreground ,meta :height 85 :family ,base-font))))
     `(org-tag-group ((,class (:inherit org-tag :height 85 :foreground ,comp))))
