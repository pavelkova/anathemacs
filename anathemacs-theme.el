...
;; font locks
     ...
     `(font-lock-comment-face ((,class (:foreground ,comment :height 0.9))))
...
;;;;; calfw
     ...
     `(cfw:face-annotation         ((,class (:foreground ,red-bg-s :inherit cfw:face-day-title))))
...
;;;;; org
     ...
     `(org-block ((,class (:background ,cblk-bg :foreground ,cblk :family ,base-font))))
     ...
     `(org-document-title ((,class (:inherit nil :family ,et-font :foreground ,base-dim :underline nil :height 2.7))))
     ...
     `(org-level-3 ((,class (:family ,et-font :height 1.5))))
     `(org-level-4 ((,class (:family ,et-font :height 1.5))))
     `(org-level-5 ((,class (:family ,et-font :height 1.5))))
     `(org-level-6 ((,class (:family ,et-font :height 1.5))))
     `(org-level-7 ((,class (:family ,et-font :height 1.5))))
     `(org-level-8 ((,class (:family ,et-font :height 1.5))))
