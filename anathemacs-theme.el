...
;;;;; helm
   ...
   `(helm-ff-prefix                   ((t :inherit helm-ff-file :background ,keyword)))
...
;;;;; org
   ...
   `(org-ellipsis                  ((t :inherit mono-xs :foreground ,comment :underline nil :weight normal)))
   ...
   `(org-pomodoro-mode-line-break  ((t :inherit mode-line :foreground ,suc)))
   `(org-pomodoro-mode-line-overtime  ((t :inherit mode-line :foreground ,war)))
