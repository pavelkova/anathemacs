...
;;;;; basics
   ...
   `(variable-pitch           ((t :inherit serif-sm)))
   ...
   `(font-lock-constant-face       ((t :foreground ,const :slant italic :weight bold)))
   `(font-lock-doc-face            ((t :foreground ,comment)))
   `(font-lock-function-name-face  ((t :foreground ,func :slant italic :weight bold)))
   `(font-lock-keyword-face        ((t :foreground ,type :slant italic :weight bold :background nil)))
   ...
   `(font-lock-string-face         ((t :foreground ,str :slant italic)))
...
;;;;; mode-line
   ...
   `(mode-line-emphasis  ((t :inherit mode-line :foreground ,highlight)))
   `(mode-line-highlight ((t :inherit mode-line :foreground ,highlight-dim :style nil)))
   `(mode-line-inactive  ((t :inherit mode-line :foreground ,comment :background ,bg-1 :box nil)))
;;;; doom modeline
   ...
   `(doom-modeline-buffer-major-mode  (( t :inherit mode-line :foreground ,highlight)))
   ...
   `(doom-modeline-buffer-timemachine (( t :inherit mode-line)))
   `(doom-modeline-debug              (( t :inherit mode-line :foreground ,comment)))

   `(doom-modeline-highlight          (( t :inherit mode-line :foreground ,highlight)))
   `(doom-modeline-host               (( t :inherit mode-line)))
   `(doom-modeline-info               (( t :inherit mode-line :foreground ,comment)))

   `(doom-modeline-lsp-error          (( t :inherit mode-line :foreground ,err)))
   `(doom-modeline-lsp-running        (( t :inherit mode-line :foreground ,keyword)))
   `(doom-modeline-lsp-success        (( t :inherit mode-line :foreground ,suc)))
   `(doom-modeline-lsp-warning        (( t :inherit mode-line :foreground ,war)))

   `(doom-modeline-panel                     (( t :inherit mode-line)))
   `(doom-modeline-persp-buffer-not-in-persp (( t :inherit mode-line :strike-through t)))
   `(doom-modeline-persp-name                (( t :inherit mono-xs :slant italic :weight bold)))
...
;;;;; org
   ...
   `(org-code                      ((t :inherit default :foreground ,fg-2)))
   `(org-column                    ((t :background ,bg-2)))
   `(org-column-title              ((t :weight bold :foreground ,green-2)))
   `(org-date                      ((t :inherit mono-sm :foreground ,fg-2 :underline t)))
   ...
   `(org-done                      ((t :inherit mono-sm :background nil :foreground ,highlight-dim :strike-through nil)))
   ...
   `(org-footnote                  ((t :inherit serif-xs :foreground ,fg-2 :slant italic)))
   ...
   `(org-quote                     ((t :background ,cblk-bg :foreground ,cblk, :slant italic)))
   ...
   `(org-roam-link                 ((t :inherit nil :slant italic :foreground ,fg-1 )))
   `(org-roam-link-current         ((t :inherit org-roam-link :foreground ,highlight)))
   `(org-roam-link-invalid         ((t :inherit org-roam-link :foreground ,war)))
   `(org-roam-link-shielded        ((t :inherit org-roam-link :foreground ,comment)))
   `(org-roam-tag                  ((t :inherit org-tag)))
