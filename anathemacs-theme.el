...
;;;;; org
     ...
     `(org-document-info-keyword ((,class (:foreground ,comment :height 90))))
     ...
     `(org-special-keyword ((,class (:foreground ,func :height 80))))
     `(org-table ((,class (:foreground ,base :background nil :height 80))))
     `(org-time-grid ((,class (:foreground ,comment))))
     `(org-todo ((,class (:foreground ,func :weight bold :background nil))))
