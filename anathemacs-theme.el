...
(let ((class '((class color) (min-colors 89)))
      ...
      (base-font    "FiraCode")
      (et-font      "ETBembo")
      ;; (et-font      "Century Schoolbook Monospace")
      (sans-font    "Lato"))
...
;;;;; org
     ...
     `(org-block-begin-line ((,class (:background ,cblk-bg :foreground ,cblk-ln :height 60))))
     `(org-block-end-line ((,class (:background ,cblk-bg :foreground ,cblk-ln :height 60))))
     ...
     `(org-date ((,class (:underline t :family ,base-font :foreground ,base-dim :height 100))))
     `(org-date-selected ((,class (:background ,highlight-dim :foreground ,bg1))))
     `(org-document-info ((,class (:slant italic :height 250))))
     `(org-document-info-keyword ((,class (:inherit org-meta-line))))
     `(org-document-title ((,class (:underline nil :height 400 :weight semi-bold))))
     ...
     `(org-ellipsis ((,class (:foreground ,comment :underline nil :height 60 :family ,base-font))))
     `(org-footnote  ((,class (:slant italic :foreground ,base-dim))))
     `(org-headline-done ((,class (:strike-through nil :foreground ,base-dim))))
     `(org-hide ((,class (:foreground ,bg1 :family ,base-font))))
     ...
     `(org-meta-line ((,class (:foreground ,comment :height 60))))
