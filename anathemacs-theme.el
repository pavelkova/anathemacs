...
;;;;; org
     ...
     `(org-document-title ((,class (:underline nil :height 3.2))))
     ...
     `(org-level-1 ((,class (:slant italic :height 1.9 :foreground ,base))))
     `(org-level-2 ((,class (:height 1.5 :foreground ,base))))
