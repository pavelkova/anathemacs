...
;;;;; magit
     `(magit-blame-culprit ((,class :background ,yellow-2 :foreground ,yellow-1)))
     `(magit-blame-date    ((,class :background ,yellow-2 :foreground ,green-1)))
     `(magit-blame-hash    ((,class :background ,yellow-2 :foreground ,func)))
     `(magit-blame-header  ((,class :background ,yellow-2 :foreground ,green-1)))
     `(magit-blame-heading ((,class :background ,yellow-2 :foreground ,green-1)))
     `(magit-blame-name    ((,class :background ,yellow-2 :foreground ,yellow-1)))
     `(magit-blame-sha1    ((,class :background ,yellow-2 :foreground ,func)))
     `(magit-blame-subject ((,class :background ,yellow-2 :foreground ,yellow-1)))
     `(magit-blame-summary ((,class :background ,yellow-2 :foreground ,yellow-1)))
     `(magit-blame-time    ((,class :background ,yellow-2 :foreground ,green-1)))
...
;;;;; mode-line
     ...
     `(mode-line-buffer-id ((,class (:inherit bold :foreground ,func :height 80))))
     `(mode-line-emphasis ((,class (:foreground ,comp :height 80))))
     `(mode-line-highlight ((,class (:style nil :height 80))))
...
;;;;; org
     `(org-agenda-clocking ((,class (:inherit fixed-pitch :background ,highlight :foreground ,bg1))))
     `(org-agenda-date ((,class (:inherit fixed-pitch :foreground ,var))))
     `(org-agenda-date-today ((,class (:inherit fixed-pitch :foreground ,keyword :weight bold))))
     `(org-agenda-date-weekend ((,class (:inherit fixed-pitch :foreground ,var))))
     `(org-agenda-diary ((,class (:inherit fixed-pitch :foreground ,keyword))))
     `(org-agenda-done ((,class (:foreground ,comment :strike-through t))))
     `(org-agenda-structure ((,class (:inherit org-level-1))))
     `(org-block ((,class (:inherit fixed-pitch :background ,cblk-bg :foreground ,cblk))))
     `(org-block-begin-line ((,class (:inherit fixed-pitch :background ,cblk-bg :foreground ,cblk-ln :height 90))))
     `(org-block-end-line ((,class (:inherit fixed-pitch :background ,cblk-bg :foreground ,cblk-ln :height 90))))
     `(org-clock-overlay ((,class (:foreground ,comp))))
     `(org-code ((,class (:inherit fixed-pitch :inherit nil :foreground ,base-dim :height 100))))
     `(org-column ((,class (:inherit fixed-pitch :background ,bg2))))
     `(org-column-title ((,class (:inherit fixed-pitch :weight bold :foreground ,green-2))))
     `(org-date ((,class (:inherit fixed-pitch :underline t :foreground ,const :height 90))))
     ...
     `(org-document-info-keyword ((,class (:inherit fixed-pitch :foreground ,comment :height 90))))
     ...
     `(org-headline-done ((,class (:strike-through t :foreground ,comment))))
     `(org-hide ((,class (:foreground ,bg1))))
     `(org-indent ((,class (:inherit org-hide))))
     `(org-kbd ((,class (:inherit region :foreground ,base :box (:line-width 1 :style released-button)))))
     `(org-level-1 ((,class (:inherit variable-pitch :slant italic :height 180))))
     `(org-level-2 ((,class (:inherit variable-pitch :slant italic :height 170 :foreground ,base))))
     `(org-level-3 ((,class (:inherit variable-pitch :foreground ,base :height 140))))
     ...
     `(org-meta-line ((,class (:inherit fixed-pitch :foreground ,meta :height 90))))
     `(org-mode-line-clock-overrun ((,class (:inherit fixed-pitch :foreground ,err :height 80))))
     ...
     `(org-special-keyword ((,class (:inherit fixed-pitch :foreground ,func :height 80))))
     `(org-table ((,class (:inherit fixed-pitch :foreground ,base :background nil :height 80))))
     `(org-time-grid ((,class (:foreground ,comment))))
     `(org-todo ((,class (:foreground ,func :inherit bold :background nil))))
     `(org-verbatim ((,class (:inherit fixed-pitch :foreground ,keyword :height 100))))
