...
;;;;; org
     ...
     `(org-document-title ((,class (:underline nil :height 2.3))))
     `(org-done ((,class (:foreground ,highlight-dim :background nil :strike-through nil :family ,base-font ))))
     `(org-drawer ((,class (:foreground ,comment :height 0.4))))
     `(org-ellipsis ((,class (:foreground ,comment :underline nil :height 0.6))))
     ...
     `(org-level-1 ((,class (:slant italic :height 1.6 :foreground ,base))))
     `(org-level-2 ((,class (:height 1.2 :foreground ,base))))
     `(org-level-3 ((,class (:height 1.2 :foreground ,base))))
     ...
     `(org-meta-line ((,class (:foreground ,comp :height 0.7))))
     `(org-mode-line-clock-overrun ((,class (:foreground ,err :height 80))))
     `(org-priority ((,class (:foreground ,war :weight bold))))
     `(org-property-value ((,class (:foreground ,base-dim :height 0.7 :family ,base-font))))
     ...
     `(org-special-keyword ((,class (:foreground ,comment :height 10))))
     `(org-tag ((,class (:foreground ,meta :height 0.6 :family ,base-font))))
     `(org-tag-group ((,class (:inherit org-tag :height 1.8 :foreground ,comp))))
