...
;;;;; basics
   ...
   `(default-italic           ((t :inherit default :italic t)))
   ...
   `(italic                   ((t :inherit default-italic :underline nil)))
...
;;;;; helm
   ...
   `(helm-buffer-file                 ((t :background ,bg-1 :foreground ,fg-1 :weight bold)))
   `(helm-buffer-not-saved            ((t :background ,bg-1 :foreground ,comp)))
   `(helm-buffer-process              ((t :background ,bg-1 :foreground ,keyword)))
   ...
   `(helm-ff-directory                ((t :background ,bg-1 :foreground ,keyword :weight bold)))
   ...
   `(helm-ff-file                     ((t :background ,bg-1 :foreground ,fg-1 :weight normal)))
   `(helm-ff-invalid-symlink          ((t :background ,bg-1 :foreground ,red-2 :weight bold)))
   `(helm-ff-prefix                   ((t :background ,keyword :foreground ,bg-1 :weight normal)))
   `(helm-ff-symlink                  ((t :background ,bg-1 :foreground ,yellow-1 :weight bold)))
   ...
   `(helm-grep-lineno                 ((t :background ,bg-1 :foreground ,type :weight bold)))
   `(helm-grep-match                  ((t :inherit helm-match)))
   `(helm-header                      ((t :inherit helm-buffer-file :underline nil :box nil)))
   ...
   `(helm-source-header               ((t :background ,bg-1 :foreground ,fg-2 :weight bold)))
...
;;;;; org
   ...
   `(org-done                      ((t :inherit sans-md :background nil :foreground ,highlight-dim :strike-through nil)))
   `(org-drawer                    ((t :inherit mono-xs :foreground ,comment)))
   `(org-ellipsis                  ((t :inherit mono-sm :foreground ,comment :underline nil)))
   ...
   `(org-habit-overdue-face        ((t :background ,err)))
   `(org-habit-overdue-future-face ((t :background ,bg-2)))
   `(org-habit-ready-face          ((t :background ,cyan-2)))
