        ...
        (:endgrouptag)
          ...
          ("AREA")
            ...
            (:endgrouptag)
              ...
              ("creatividad")
                (:grouptags)
                ("borrador")("fragmento")("idea")
              (:endgrouptag)
              (:startgrouptag)
              ("personal")
                (:grouptags)
                ("diario")("estilo")("organización")("salud")
              (:endgrouptag)
              (:startgrouptag)
              ("trabajo")
                (:grouptags)
                ("anathemacs")("devblog")("dotfiles")("personal-brand")
                ("playsette")("soliloquy")("vidal")("worldview")
              (:endgrouptag)
          (:startgrouptag)
          ("PROYECTO")
            (:grouptags)
            ;; trabajo
            ("anathemacs")("devblog")("dgar")("dotfiles")("personal-brand")
            ("playsette")("soliloquy")("vidal")("worldview")
            ;; creatividad
            ("an-unnatural-growth")("ensayos")("voidcorp")
          (:endgrouptag)
          (:startgrouptag)
          ("RECURSO")
            (:grouptags)
            ("artículo")("chuleta")("enlace")
          (:endgrouptag)))
