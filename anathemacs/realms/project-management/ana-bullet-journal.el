...
;; -----------------------------------------------------
;; COPIED FROM org-bullets.el
;; IN PROGRESS: modify to assign custom bullet icons
;;              according to header tag instead of
;;              header level
;; -----------------------------------------------------
...
;;;###autoload
(define-minor-mode org-bullet-journal-mode
